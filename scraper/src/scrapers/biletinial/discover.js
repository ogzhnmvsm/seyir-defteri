...
const DEFAULT_URL = 'https://biletinial.com/tr-tr/tiyatro/istanbul?minprice=0&maxprice=22000&order=1';
...
async function discoverPlays(startUrl = DEFAULT_URL) {
    ...
    const discovered = [];
    let pageIndex = 1;
    const maxPages = process.env.PAGE_LIMIT ? parseInt(process.env.PAGE_LIMIT) : 50;
    ...
    while (pageIndex <= maxPages) {
        ...
        console.log(`➕ Bu sayfada: ${items.length}, yeni: ${newCount} (toplam: ${discovered.length})`);
